...
<div class="tbl-header">
	<table cellpadding="0" cellspacing="0" border="0">
		<thead>
			<tr>
				<th>institution Name: Apj Abdul Kalam Technological University</th>
...
<body>
	<table>
		...
		<tbody>
			...
			<tr>
				<td>NEE101</td>
				<td colspan="2">Mathematics-11</td>
				<td>Theory</td>
				<td>100</td>
				<td>30</td>
	...
	<center>
		<h6>Note: Institution doesn't own for the errors or omissions, if
			any, in this statement. Designed & Developed by BTech Days Team</h6>
	</center>
	<hr class="new1">
	<center>
		<h6></h6>
